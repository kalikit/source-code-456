  ...
  <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item active">
        <a href="http://localhost:3000/employee/Home.php" class="menu-link">
      ...
      <li class="menu-item">
        ...
        <?php
            foreach ($data as $item) {
              foreach ($item['permissions'] as $item_pms) {
        ?>
            <ul class="menu-sub">
              <li class="menu-item">
                <?php 
                if($item_pms == "Quản lý khách hàng"){ ?>
                <a href="http://localhost:3000/employee/manage/customers/customers.php" class="menu-link">
                  <div data-i18n="Without menu">Quản lý khách hàng</div>
                </a>
                <?php } 
                else if($item_pms == "Quản lý khảo sát"){ ?>
                <a href="http://localhost:3000/employee/manage/survey/survey.php" class="menu-link">
                  <div data-i18n="Without menu">Quản lý khảo sát</div>
                </a>
                <?php } 
                else{ ?>
                  <a href="#" class="menu-link">
                  <div data-i18n="Without menu"><?php echo $item_pms; ?></div>
                </a>
                <?php } ?>
              </li>
            </ul>
      ...
      <li class="menu-item">
        <a href="http://localhost:3000/form/logout.php" class="menu-link">
