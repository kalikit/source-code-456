            ...
            <div class="col-lg-10 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        ...
                        <h2 style="text-align: center; margin-top: 15px;"> Phân quyền </h2>
                        <div class="">
                            <button type="button" class="btn btn-primary" id="clickModal" data-toggle="modal" data-target="#myModal" style="margin-left: 50px;"> Thêm mới</button>
                        </div>
                        <div class="">
                                    ...
                                    <?php foreach ($permissions as $item) { ?>
                                        <tr>
                                            ...
                                            <td style="width:200px;text-align:center">
                                                <a href="edit-permission.php?id=<?= $item['id']; ?>" class="btn btn-primary btn-sm"> Sửa quyền </a>
                                                <a onclick="return confirm('Bạn có chắc xóa không ?')" href="delete-permission.php?id=<?= $item['id']; ?>" class="btn btn-danger btn-sm"> Xóa quyền </a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
...
if (isset($_POST['submit'])) {
    ...
    $query_insert  = mysqli_query($ketnoi, $sql_insert);
